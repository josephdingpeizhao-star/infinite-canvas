...
桌面安装包和免安装便携 ZIP 都会内置画布前端、Canvas Agent、Node 运行环境和 Windows x64 Codex 程序；便携 ZIP 还会带上完整工作台、独立 Python 环境以及 `_shared`、杯类、盘子、碗品类规则。构建与使用说明见 [Windows 桌面版](desktop/README.md)。
