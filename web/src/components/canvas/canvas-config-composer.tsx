        ...
        >
            <div className="mb-2 flex items-center justify-between gap-2">
                <div className="flex min-w-0 items-baseline gap-2">
                    ...
                    <div className="truncate text-[11px] opacity-55">@ 引用已连接素材，统一使用全局编号</div>
                </div>
            ...
            <div className="relative rounded-xl border" style={{ background: theme.node.fill, borderColor: theme.node.stroke }}>
                {!value.trim() ? <div className="pointer-events-none absolute left-3 top-2 text-sm leading-7" style={{ color: theme.node.placeholder }}>输入提示词，按 @ 引用已连接的图片或文本</div> : null}
                <div
                    ref={editorRef}
                    contentEditable
